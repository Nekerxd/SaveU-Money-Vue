    ...
    <div class="col-12">
      <div class="card">
        ...
        <DataTable
          ...
          currentPageReportTemplate="Mostrando de {first} à {last} de {totalRecords} receitas"
          :sortField="sortField"
          :sortOrder="sortOrder"
          @sort="onSort"
        >
...
const loadLancamentos = async () => {
  try {
    ...
    lancamentos.value = lancamentos.value.filter(lancamento => lancamento.type === 'Receita');
